        ...
        <div class="container-login">
            ...
            <form method="post" action="../Controllers/loginHandler.php">
                ...
                <div class="mb-3">
                  ...
                  <input type="password" class="form-control" id="exampleInputPassword11" name="exampleInputPassword11">
                </div>

                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label"><a href="register.php">Register Link Here</a></label>
                  </div>
